...
\publisheddate{XX Març, 2025}
\currentdate{XX Març, 2025}
...
\corresp{Autor de contacte: Daniel García (email: @uib.es)}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{mvc.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{bigO.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{interficie1.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{interficie2.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{executorService.png}}
